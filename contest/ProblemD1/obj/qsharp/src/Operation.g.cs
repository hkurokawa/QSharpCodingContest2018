...
[assembly: OperationDeclaration("Solution", "Solve (x : Qubit[], y : Qubit, b : Int[]) : ()", new string[] { }, "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD1/Operation.qs", 164L, 6L, 5L)]
#line hidden
namespace Solution
{
    public class Solve : Operation<(QArray<Qubit>,Qubit,QArray<Int64>), QVoid>, ICallable
    {
        ...
        {
            var (x,y,b) = __in;
#line 9 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD1/Operation.qs"
            foreach (var i in new Range(0L, (b.Count - 1L)))
            {
#line 11 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD1/Operation.qs"
                if ((b[i] == 1L))
                {
#line 13 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD1/Operation.qs"
