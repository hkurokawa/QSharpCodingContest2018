...
[assembly: OperationDeclaration("Solution", "Test (b : Int[]) : ()", new string[] { }, "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs", 185L, 7L, 5L)]
#line hidden
namespace Solution
{
    public class Test : Operation<QArray<Int64>, QVoid>, ICallable
    {
        ...
        {
            var b = __in;
#line 10 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            var N = b.Count;
#line 11 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            var qs = Allocate.Apply((N + 1L));
#line 13 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            var x = qs?.Slice(new Range(0L, (N - 1L)));
#line 14 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            var y = qs[N];
#line 15 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            MicrosoftQuantumPrimitiveX.Apply(qs[0L]);
#line 16 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            Solve.Apply((x, y, b));
#line 17 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            MicrosoftQuantumExtensionsDiagnosticsDumpRegister.Apply(("qs.txt", qs?.Slice(new Range(N, N))));
#line 18 "/home/hiroshi/git/github.com/hkurokawa/QSharpCodingContest2018/contest/ProblemD2/Test.qs"
            ResetAll.Apply(qs);
#line hidden
            Release.Apply(qs);
#line hidden
